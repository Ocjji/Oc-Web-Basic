...
vehicles.forEach(ele => {
    ...
    li.innerHTML =
        ...
        <div class="price">
        <a href="">
            <p><i class="xi-shield-checked-o"></i>일반자차 <em>(만 21세 이상)</em><span>${ele.price1}원 부터</span></p></a>
            <a href=""><p><i class="xi-shield-checked-o"></i>완전자차 <em>(만 23세 이상)</em><span>${ele.price2}원 부터</span></p></a>
            <a href=""><p><i class="xi-shield-checked-o"></i>슈퍼자차 <em>(만 26세 이상)</em><span>${ele.price3}원 부터</span></p></a>
        </div>
        `;
