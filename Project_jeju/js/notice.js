...
function makePaging(boardArr) {
    ...
    // console.log(noticeBoardPagingBtn);
}
...
function makeBoard(categorynum, boardArr, page) {
    ...
    // console.log(noticeBoardTable[0].firstElementChild.children[3]);
    for (let i = boardArr.length - ((page - 1) * 10) - 1; i >= Math.max(boardArr.length - (page * 10), 0); i--) {
        ...
        // console.log(noticeBoardTable[categorynum].children[0].children[3]);
...
//     `;
//     tbody.append(tr);
//     noticeBoardTableAll.append(tbody);
// }
