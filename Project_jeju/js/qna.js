...
const qnaArrListAns = [
    ...
    '<p><strong>여행계약서는 예약상태가 [예약확정]일 때만 발송</strong>됩니다.&nbsp;</p><p><span style="color: rgb(184, 49, 47);">[대기예약]인 경우 예약 상태가 [예약확정]이 변경되면 해당 여행자의 입력된 휴대폰 번호로 여행계약서 알림톡이 발송</span>되며, 받으신 알림톡 내 링크 주소로 접속하면 여행계약서 내용 확인 및 동의를 하실 수 있습니다.</p>'
];
